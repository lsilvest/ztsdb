...
// ztsdb: this section moved to tz.hpp start
...
// };
// ztsdb: this section moved to tz.hpp end
...
int
tz::tzload(char const *name, state *sp, bool doextend)
// ztsdb: mod end
{
#ifdef ALL_STATE
...
tzalloc(char const *name)
{
  ...
  timezone_t sp = static_cast<timezone_t>(malloc(sizeof *sp));
  // ztsdb mod end
  if (sp) {
